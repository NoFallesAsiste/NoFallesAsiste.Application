    ...
    public partial class addUpdate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Meet", new DateTime(2021, 9, 21, 12, 0, 0, 0, DateTimeKind.Unspecified), "Manejo de framework Entity de .net", 1, "Programssción profunda" },
                    { 2, "Meet", new DateTime(2021, 9, 21, 12, 0, 0, 0, DateTimeKind.Unspecified), "Future with will", 1, "English 2" }
                });

            migrationBuilder.UpdateData(
                table: "Programs",
                keyColumn: "ProgramsId",
                keyValue: 1,
                column: "Description",
                value: "Programss para el estudio del ciclo de vida del software y su desarrollo");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                column: "Description",
                value: "Programa para el estudio del ciclo de vida del software y su desarrollo");
